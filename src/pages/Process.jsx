...
const Process = () => {
    ...
    return (
        <div className="min-h-screen p-4 md:p-8 bg-gray-100">
            <h1 className="mb-6 text-2xl md:text-3xl font-semibold text-gray-800">Production Process and Finished Product</h1>
            ...
            <div className="overflow-x-auto">
                <table className="min-w-full bg-white border border-gray-300 rounded-lg shadow-lg">
                    <thead className="bg-gray-200">
                        <tr>
                            <th className="px-2 md:px-6 py-3 text-left text-gray-700">Check</th>
                            <th className="px-2 md:px-6 py-3 text-left text-gray-700">ID</th>
                            <th className="px-2 md:px-6 py-3 text-left text-gray-700">Item Name</th>
                            <th className="px-2 md:px-6 py-3 text-left text-gray-700">Stockout Item</th>
                            <th className="px-2 md:px-6 py-3 text-left text-gray-700">Category</th>
                            <th className="px-2 md:px-6 py-3 text-left text-gray-700">Type</th>
                            <th className="px-2 md:px-6 py-3 text-left text-gray-700">Quantity</th>
                            <th className="px-2 md:px-6 py-3 text-left text-gray-700">Status</th>
                            <th className="px-2 md:px-6 py-3 text-left text-gray-700">Actions</th>
                        </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-200">
                        {processes.map((process) => (
                            <tr key={process.id} className="transition duration-200 ease-in-out hover:bg-gray-100">
                                ...
                                <td className="px-2 md:px-6 py-4 text-gray-700">{process.id}</td>
                                <td className="px-2 md:px-6 py-4 text-gray-700">{process.request.item?.item?.name}</td>
                                <td className="px-2 md:px-6 py-4 text-gray-700">{process.request.request_for.name}</td>
                                <td className="px-2 md:px-6 py-4 text-gray-700">{process.request.item?.item?.category?.name}</td>
                                <td className="px-2 md:px-6 py-4 text-gray-700">{process.request.item?.item?.type?.name}</td>
                                <td className="px-2 md:px-6 py-4 text-gray-700">{process.quantity}</td>
                                ...
                                <td className="px-2 md:px-6 py-4 space-x-2">
                                    <button
