...
function TotalRowMaterialOut() {
  return (
    <div className="p-4">
      <h1 className='text-2xl text-center'>Details Of Row Materials <i className='text-[#00BDD6]'>Out Of Stock</i></h1>
...
export default TotalRowMaterialOut